...
@dso_cache = dso_local local_unnamed_addr global [534 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 624881148, ; hash 0x253eedfc, from name: Microsoft.Extensions.AI.Abstractions.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 747884119, ; hash 0x2c93ce57, from name: Microsoft.Extensions.AI.Abstractions
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Microsoft.Extensions.AI.Abstractions.dll.so
		ptr null; void* handle (0x0)
	}, ; 80
	...
	%struct.DSOCacheEntry {
		i64 768247346, ; hash 0x2dca8632, from name: libaot-Microsoft.Extensions.AI.Abstractions
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Microsoft.Extensions.AI.Abstractions.dll.so
		ptr null; void* handle (0x0)
	}, ; 85
	...
	%struct.DSOCacheEntry {
		i64 1085456849, ; hash 0x40b2c1d1, from name: libaot-Microsoft.Extensions.AI.Abstractions.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Microsoft.Extensions.AI.Abstractions.dll.so
		ptr null; void* handle (0x0)
	}, ; 131
	...
	%struct.DSOCacheEntry {
		i64 2064240843, ; hash 0x7b09d0cb, from name: libaot-OllamaSharp
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2307129674, ; hash 0x8984014a, from name: aot-Microsoft.Extensions.AI.Abstractions.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Microsoft.Extensions.AI.Abstractions.dll.so
		ptr null; void* handle (0x0)
	}, ; 285
	...
	%struct.DSOCacheEntry {
		i64 2794124816, ; hash 0xa68af610, from name: aot-OllamaSharp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-OllamaSharp.dll.so
		ptr null; void* handle (0x0)
	}, ; 351
	...
	%struct.DSOCacheEntry {
		i64 3116900294, ; hash 0xb9c81fc6, from name: libaot-OllamaSharp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-OllamaSharp.dll.so
		ptr null; void* handle (0x0)
	}, ; 402
	...
	%struct.DSOCacheEntry {
		i64 3154783730, ; hash 0xbc0a2df2, from name: aot-OllamaSharp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-OllamaSharp.dll.so
		ptr null; void* handle (0x0)
	}, ; 409
	...
	%struct.DSOCacheEntry {
		i64 3326051898, ; hash 0xc63f863a, from name: OllamaSharp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-OllamaSharp.dll.so
		ptr null; void* handle (0x0)
	}, ; 423
	...
	%struct.DSOCacheEntry {
		i64 3647498933, ; hash 0xd9686ab5, from name: aot-Microsoft.Extensions.AI.Abstractions
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Microsoft.Extensions.AI.Abstractions.dll.so
		ptr null; void* handle (0x0)
	}, ; 457
	...
	%struct.DSOCacheEntry {
		i64 4058780466, ; hash 0xf1ec1332, from name: OllamaSharp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-OllamaSharp.dll.so
		ptr null; void* handle (0x0)
	}, ; 506
